...
namespace eCommerce.Office.Migrations
{
    ...
    [Migration("20230712210443_ColaboradorToVeiculo")]
            ...
            modelBuilder.Entity("eCommerce.Office.Models.ColaboradorSetor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ColaboradorId = 1,
                            SetorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 12, 18, 4, 42, 835, DateTimeKind.Unspecified).AddTicks(3506), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 6,
                            SetorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 12, 18, 4, 42, 835, DateTimeKind.Unspecified).AddTicks(3534), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 5,
                            SetorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 12, 18, 4, 42, 835, DateTimeKind.Unspecified).AddTicks(3536), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 4,
                            SetorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 12, 18, 4, 42, 835, DateTimeKind.Unspecified).AddTicks(3538), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 7,
                            SetorId = 3,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 12, 18, 4, 42, 835, DateTimeKind.Unspecified).AddTicks(3539), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 2,
                            SetorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 12, 18, 4, 42, 835, DateTimeKind.Unspecified).AddTicks(3541), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 3,
                            SetorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 12, 18, 4, 42, 835, DateTimeKind.Unspecified).AddTicks(3542), new TimeSpan(0, -3, 0, 0, 0))
                        });
                });
