...
namespace eCommerce.Office.Migrations
{
    ...
    [Migration("20230708192827_BancoInicial")]
            ...
            modelBuilder.Entity("eCommerce.Office.Models.ColaboradorSetor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ColaboradorId = 1,
                            SetorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 8, 16, 28, 27, 605, DateTimeKind.Unspecified).AddTicks(8876), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 6,
                            SetorId = 1,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 8, 16, 28, 27, 605, DateTimeKind.Unspecified).AddTicks(8900), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 5,
                            SetorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 8, 16, 28, 27, 605, DateTimeKind.Unspecified).AddTicks(8901), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 4,
                            SetorId = 2,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 8, 16, 28, 27, 605, DateTimeKind.Unspecified).AddTicks(8903), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 7,
                            SetorId = 3,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 8, 16, 28, 27, 605, DateTimeKind.Unspecified).AddTicks(8904), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 2,
                            SetorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 8, 16, 28, 27, 605, DateTimeKind.Unspecified).AddTicks(8906), new TimeSpan(0, -3, 0, 0, 0))
                        },
                        new
                        {
                            ColaboradorId = 3,
                            SetorId = 4,
                            Criado = new DateTimeOffset(new DateTime(2023, 7, 8, 16, 28, 27, 605, DateTimeKind.Unspecified).AddTicks(8907), new TimeSpan(0, -3, 0, 0, 0))
                        });
                });
